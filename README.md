...
Audience-specific landing site for **hoteldebtexpert.com**, bundling the Hotel Capital Stack diagnostic. Static — no build step.
...
```bash
git init && git add . && git commit -m "Hotel Debt Expert site"
git branch -M main
gh repo create moonman312/advisor-site --public --source=. --remote=origin --push
vercel && vercel --prod
```
